...
\begin{tikzpicture}[node distance=9mm and 10mm]
  ...
  \node[freq,right=of fft] (fproj)
    {All 17 retained bins remain active\\no below-25-Hz frequency mask\\Linear $17\!\to\!192$};
  ...
  \node[note,above=2mm of add] {Position retained: $z_0=z_s+P$};
  ...
  \node[note,below=7mm of loss]
    {Participant 12 control: first 30 images per available class\\Same seed and budget as D-098; only the frequency mask changes};
