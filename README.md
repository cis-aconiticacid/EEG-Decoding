...
This repository is the public, English-language record for a numbered sequence of EEG-ImageNet training and diagnostic experiments. Start with the [Training experiment index](Training/README.md); the current maintained experiment is [D-099](Training/D-099/README.md).
